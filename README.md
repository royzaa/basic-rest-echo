[![Build Status](https://app.travis-ci.com/royzaa/basic-rest-echo.svg?branch=main)](https://app.travis-ci.com/royzaa/basic-rest-echo)
[![codecov](https://codecov.io/gh/royzaa/basic-rest-echo/branch/main/graph/badge.svg?token=hxaHIVyoBN)](https://codecov.io/gh/royzaa/basic-rest-echo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/royzaa/basic-rest-echo/blob/master/LICENSE)
[![Go Reference](https://pkg.go.dev/badge/github.com/royzaa/basic-rest-echo.svg)](https://pkg.go.dev/github.com/royzaa/basic-rest-echo)
[![GoReportCard Badge](https://goreportcard.com/badge/github.com/royzaa/basic-rest-echo)](https://goreportcard.com/report/github.com/royzaa/basic-rest-echo)
[![Total alerts](https://img.shields.io/lgtm/alerts/g/royzaa/basic-rest-echo.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/royzaa/basic-rest-echo/alerts/)
...
<!--toc-->
- [Echo REST API boilerplate](#basic-rest-echo-boilerplate)
    * [Overview](#overview)
    * [Features](#features)
...
> **DO NOT FORK** this is meant to be used from **[Use this template](https://github.com/royzaa/basic-rest-echo/generate)** feature.

1. Click on **[Use this template](https://github.com/royzaa/basic-rest-echo/generate)**
